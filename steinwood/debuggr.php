...
Debuggr version 0.94 by Tor de Vries
Updated 10 November 2020
- Introduced "dark mode" as a default
- Added the "Files" menu as an option (see $showFilesMenu)
...
$userName = "Shawn Stephens"; // put in your own name
$userEmail = "shawn.stephens@wsu.edu"; // put in your own email address

$pagePassword = "ew7XuHfUB2"; // set a password
